...
<template>
  ...
  <main>
    <div class="container">
      <ProgramCard
        name="Google Chrome"
        description="Браузер від компанії Google"
      ...
      <ProgramCard
        ...
        linkcommon="https://files3.codecguide.com/K-Lite_Codec_Pack_1890_Mega.exe"
      />
      ...
      <ProgramCard
        ...
        description="Кращий інструмент для правильної деінсталяції програм"
