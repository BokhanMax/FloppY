  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="space-y-4">
      ...
      <div class="bg-green-50 rounded-lg shadow-md overflow-hidden">
        ...
        >
          <h3 class="text-lg font-semibold text-green-dark">
            Як знати, яку версію (x32 or x64) мені завантажити?
          </h3>
          <svg
            id="icon-faq1"
        ...
        >
          <div class="px-6 pb-4">
            <p class="text-gray-700 leading-relaxed mt-3 mb-2">
              ...
              «64-розрядна операційна система», завантажте 64-розрядну версію для кращої
              продуктивності та сумісності. Якщо відображається «32-розрядна операційна система»,
              завантажте 32-розрядну версію. Більшість сучасних комп’ютерів (виготовлених після 2010
              року) підтримують 64-розрядні версії, і ми рекомендуємо використовувати 64-розрядні
              версії, коли це можливо, оскільки вони можуть використовувати більше оперативної
              пам’яті та забезпечувати кращу продуктивність.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-green-50 rounded-lg shadow-md overflow-hidden">
        ...
        >
          <h3 class="text-lg font-semibold text-green-dark">
            Де знайти ключі або кряки для програм?
          </h3>
          <svg
            id="icon-faq2"
            class="w-5 h-5 text-green-600 transform transition-transform duration-200"
        ...
        >
          <div class="px-6 pb-4">
            <p class="text-gray-700 leading-relaxed mt-3 mb-2">
              ...
              комп'ютерах. Якщо є питання по роботі програми - звертайтесь до розробників.
            </p>
          </div>
        </div>
      </div>
