  ...
  <div v-else-if="program" class="max-w-5xl mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
      <div class="flex flex-col md:flex-row gap-6 items-start md:items-center">
        ...
        <div class="shrink-0">
          <div
            class="w-24 h-24 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-200"
          >
            <picture>
              <source
                media="(width < 800px)"
        ...
        <div class="flex-1">
          ...
          <div class="flex flex-wrap items-center gap-4 text-gray-600 mb-4">
            ...
            <span
              v-if="categoryName"
              class="text-sm bg-emerald-50 text-emerald-700 px-3 py-1 rounded-full"
            >
              {{ categoryName }}
            </span>
            <span
              v-if="program.ispaid"
              class="flex items-center text-sm text-red-500 font-semibold"
            >
              <svg
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a
          v-if="program.linkcommon"
          :href="program.linkcommon"
          target="_blank"
          rel="noopener noreferrer"
          class="bg-linear-to-b from-white to-gray-100 hover:from-gray-50 hover:to-gray-200 text-gray-800 border border-gray-300 px-6 py-4 rounded-lg transition-all text-center font-semibold text-lg flex items-center justify-center gap-2 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06),inset_0_1px_0_0_rgba(255,255,255,0.8)] hover:shadow-[0_2px_4px_-1px_rgba(0,0,0,0.1),0_1px_2px_-1px_rgba(0,0,0,0.06),inset_0_1px_0_0_rgba(255,255,255,0.8)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]"
        >
        ...
        <a
          v-if="program.textupdate && program.linkupdate"
          :href="program.linkupdate"
          target="_blank"
          rel="noopener noreferrer"
          class="bg-linear-to-b from-white to-gray-100 hover:from-gray-50 hover:to-gray-200 text-gray-800 border border-gray-300 px-6 py-4 rounded-lg transition-all text-center font-semibold text-lg flex items-center justify-center gap-2 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06),inset_0_1px_0_0_rgba(255,255,255,0.8)] hover:shadow-[0_2px_4px_-1px_rgba(0,0,0,0.1),0_1px_2px_-1px_rgba(0,0,0,0.06),inset_0_1px_0_0_rgba(255,255,255,0.8)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]"
        >
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div
            class="shrink-0 w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center"
          >
            <svg
        ...
        >
          ...
          >
            <svg
              class="w-5 h-5"
              :class="program.ispaid ? 'text-red-600' : 'text-green-600'"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div class="flex-1 min-w-0">
            ...
            <div v-if="program.ispaid" class="text-xs text-red-600 mt-1">
              Потрібна підтримка розробника
            </div>
          </div>
        </div>
        ...
        <div
          v-if="program.website"
          class="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 md:col-span-2"
        >
          <div class="shrink-0 w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
            <svg
              class="w-5 h-5 text-[#0071e3]"
